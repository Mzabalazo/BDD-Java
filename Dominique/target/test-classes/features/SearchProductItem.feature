...
Feature: Search Product
  ...
  Scenario Outline: "<ScenarioDescription>"
    ...
    Examples:
      ...
      | 2  | Samsung Galaxy S21 FE 5G DS + Samsung Galaxy Buds Live | Positive     | E2E      | Samsung Galaxy S21 FE 5G DS + Samsung Galaxy Buds Live | R399 PM | 36 months | Online Exclusive |


# you can add any additional test  v scenarios by changing the product and number of items